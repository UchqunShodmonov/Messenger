...
import uz.uchqun.telegramclone.ui.message_recycler_view.view_holders.AppHolderFactory
import uz.uchqun.telegramclone.ui.message_recycler_view.view_holders.MessageHolder
...
class SingleChatAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onViewDetachedFromWindow(holder: RecyclerView.ViewHolder) {
        (holder as MessageHolder).onDetached()
